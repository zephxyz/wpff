...
do
{
    ...
    if (turn % 2 == 1)
    {
        ...
        }  // ověření zda hráč má odhoditelnou kartu
        do
        {
            for (i = 0; i < count1; i++)
            {
            ...
            else if (choice < 0 || choice > count1 || !Tossable[choice - 1] || !tryparse)
            {
        ...
        if (choice > 0)
        {
            topTossed = id1[choice - 1];
            tossed[tossnr] = topTossed;
            tossnr++;
            if (id1[choice - 1] == 19 || id1[choice - 1] == 29 || id1[choice - 1] == 39 || id1[choice - 1] == 49)
            {
                p1hasAceImmunity = true;
                p2hasAceImmunity = false;
            }
            if (id1[choice - 1] == 10 || id1[choice - 1] == 20 || id1[choice - 1] == 30 || id1[choice - 1] == 40)
            {
                p1hasSevenImmunity = true;
                p2hasSevenImmunity = false;
                drawSeven += 2;
            }
            if (id1[choice - 1] == 17 || id1[choice - 1] == 27 || id1[choice - 1] == 37 || id1[choice - 1] == 47)
            {
